...
public class HttpConnect {
	...
	private HttpConnect() {
		...
		params.setIntParameter(CoreConnectionPNames.SO_TIMEOUT, 1000 * 5);
		params.setIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, 1000 * 5);
	...
	public void  setConnectionTime(int time) {
		HttpParams params = httpClient.getParams();
		params.setIntParameter(CoreConnectionPNames.SO_TIMEOUT, time);
		params.setIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, time);
	}
