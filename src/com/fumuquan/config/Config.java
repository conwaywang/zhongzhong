...
public class Config {
	...
	private static final String APP_CATCH_FOLDER = "Catch";
	private static final String APP_LOG_FOLDER = "Log";
	private static final String APK_NAME = "fmq.apk";

	private String sAppFolderPath;	
	private String sAppDataPath;		//原始数据目录
	private String sAppCatchPath;		//缓存目录
	private String sAppLogPath; // 日志目录
	...
	private Config(){
		...
		sAppCatchPath = sAppFolderPath + APP_CATCH_FOLDER + File.separator;		//缓存目录
	}
